...
const KillSwitch = (function() {
  ...
  function showMaintenancePage() {
    ...
    overlay.innerHTML = '<div style="text-align:center;max-width:480px;padding:32px;">' +
      ...
      '<h1 style="font-size:28px;font-weight:800;margin-bottom:16px;background:linear-gradient(135deg,#fff,#c9a227);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">Em Manutenção</h1>' +
      ...
      '<div style="display:inline-block;background:rgba(201,162,39,.12);color:#c9a227;padding:8px 20px;border-radius:100px;font-size:13px;font-weight:600;border:1px solid rgba(201,162,39,.2);">Maestros da IA</div>' +
      '</div>';
